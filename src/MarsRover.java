...
public class MarsRover {
    public static void main(String args[]) {
        ...
        moveRovers(input, roversArray, haveCoordinatesBeenRequested, numberOfRovers, mapSize);
        printRoverCoordinates(roversArray);
    }

    private static void moveRovers(Scanner input, ArrayList roversArray, Boolean haveCoordinatesBeenRequested, int numberOfRovers, String mapSize) {
